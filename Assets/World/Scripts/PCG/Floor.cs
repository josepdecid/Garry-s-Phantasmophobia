...
public class Floor : MonoBehaviour
{
    ...
    public Room GetGridRoom(Vector2Int position) {
        return GetGridRoom(position.x, position.y);
    }
    ...
    public void FixDoorMatching(Room newRoom, HashSet<Door> openDoors, Key key) {
    ...
    private void SpawnDoor(Door door, Key key) {
